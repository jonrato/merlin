...
<div class="row">
  <div class="forumlist-top-controls col-12">
    ...
    <div class="float-right">
      <a href="{% url 'forum_tracking:mark_subforums_read' forum.pk %}" class="d-inline-block"><i class="fa fa-check-circle-o">&nbsp;</i>{% trans "Marcar como lido" %}</a>
    </div>
    {% endif %}
  </div>
</div>
...
<div class="mt-4 mb-3 row">
  <div class="col-6 col-md-4 forum-actions-block">
    ...
    <a href="{% url 'forum_conversation:topic_create' forum.slug forum.pk %}" class="btn btn-dark btn-sm"><i class="fa fa-comments fa-lg"></i>&nbsp;{% trans "Iniciar novo tópico" %}</a>
    {% endif %}
  </div>
  <div class="col-12 col-md-8">
    {% if topics|length > 0 and request.user.is_authenticated %}
    <div class="float-left">
      <a href="{% url 'forum_tracking:mark_topics_read' forum.pk %}" class="my-1 d-inline-block">{% trans "Marcar tópico como lido" %}</a>
    </div>
    {% endif %}
...
{% endwith %}
{% trans "Acompanhe os tópicos" as topics_title_trans %}
