...
class History(models.Model):
    ...
    content_object  = GenericForeignKey('content_type') # is the actual object
    ...
    class Meta:
        verbose_name_plural = "Histórico de Visualizações"
        verbose_name = "Histórico de Visualizações"
